    ...
    <v-row class="pt-10"> 
        <v-col cols="12" sm="8">
                ...
                <v-card v-if="hide == false" color="#55B4B0" rounded="xl">
                    ...
                    <v-text-field color="white" v-model="laboratory" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: laboratory}" label="Nombre del Laboratorio/Drogueria" disabled></v-text-field>
                    <v-text-field color="white" v-model="name" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: name}" label="Nombre Génerico" disabled></v-text-field>
                    <v-text-field color="white" v-model="concentration" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: concentration }" label="Concentración" disabled></v-text-field>
                    <v-text-field color="white" v-model="form" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: form }" label="Forma Farmacéutica" disabled></v-text-field>
                    <v-text-field color="white" type="date" v-model="expiration" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: expiration }" label="Fecha de Expiración" disabled></v-text-field>
                    <v-text-field color="white" type="number" v-model="quantity" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: quantity }" label="Cantidad" disabled></v-text-field>
                    <v-text-field color="white" class="pl-10 pt-2 pr-10" v-model="barcode" v-bind="{ placeholder: barcode }" label="Lote - Código" disabled></v-text-field>
                     <v-text-field color="white" v-model="verification1" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification1 }" label="Coincide con la documentación recibida y registrada"></v-text-field>
                    <v-text-field color="white" v-model="verification2" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification2 }" label="Embalaje en perfecto estado"></v-text-field>
                    <v-text-field color="white" v-model="verification3" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification3 }" label="No contiene ninguna contaminación o daño en el empaque"></v-text-field>
                    ...
                    <v-text-field v-model="verification1" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification1 }" hint="Verification1"></v-text-field>
                    <v-text-field v-model="verification2" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification2 }" hint="Verification2"></v-text-field>
                    <v-text-field v-model="verification3" class="pl-10 pt-2 pr-10" v-bind="{ placeholder: verification3 }" hint="Verification3"></v-text-field>
